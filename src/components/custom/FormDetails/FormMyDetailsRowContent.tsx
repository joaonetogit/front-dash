import type { IFormMyDetailsRowContent } from '@/types/components/FormMyDetailsRowContent';
			...
			<div className="flex max-w-[824px] flex-col sm:flex-row sm:justify-between sm:gap-8">
				{(title || supportText) && (
					<div className="w-full max-w-72 flex-1 text-sm sm:text-base">
						{title && <h3 className={`${hiddenTitleOnMobile && 'hidden sm:block'} font-medium text-zinc-700`}>{title}</h3>}
