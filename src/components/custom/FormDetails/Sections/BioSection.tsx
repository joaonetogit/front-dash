...
export default function BioSection({ form }: IForm) {
	...
	return (
		<FormMyDetailsRowContent title="Bio" supportText="Write a short introduction.">
			<FormField
					...
					<FormItem>
						<div className="mt-5 flex flex-col gap-4 sm:mt-0 sm:gap-3">
							<div className="flex flex-col items-start gap-2 sm:flex-row sm:gap-4">
								<Select>
									<SelectTrigger className="w-full" aria-label="Select text style">
							...
							<div className="space-y-[6px]">
								...
								<p className="text-sm text-muted-foreground">
									{charCount <= 0 ? "You've reached the character limit" : `${charCount} characters left`}
								</p>
							</div>
						</div>
						<FormMessage />
